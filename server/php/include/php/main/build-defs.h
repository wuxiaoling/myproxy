...
#define CONFIGURE_COMMAND " './configure'  '--prefix=/usr/local/php' '--with-apxs2=/usr/local/apache/bin/apxs'"
...
#define PHP_IFX_LIBS		""
#define PHP_INSTALL_IT		"$(mkinstalldirs) '$(INSTALL_ROOT)/usr/local/apache/modules' &&                 $(mkinstalldirs) '$(INSTALL_ROOT)/usr/local/apache/conf' &&                  /usr/local/apache/bin/apxs -S LIBEXECDIR='$(INSTALL_ROOT)/usr/local/apache/modules'                        -S SYSCONFDIR='$(INSTALL_ROOT)/usr/local/apache/conf'                        -i -a -n php7 libphp7.la"
...
#define PHP_EXTENSION_DIR       "/usr/local/php/lib/php/extensions/no-debug-zts-20160303"
